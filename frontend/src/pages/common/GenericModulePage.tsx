...
const MODULE_DATA: Record<string, ModuleConfig> = {
  ...
  '/data': {
    ...
    subtitle: 'Central database connectors, API health, and data validation pipeline.',
    category: 'Data Engineering',
    badge: 'Automated 14ms Sync',
    icon: Database,
    highlights: [
      'Direct synchronization with national, state & ministry infrastructure portals',
      'Automated anomaly detection in submitted physical progress reports',
      'Secure schema validation and integrity verification',
    ],
  },
  '/reports': {
