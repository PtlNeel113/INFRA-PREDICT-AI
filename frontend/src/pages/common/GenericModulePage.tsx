...
const MODULE_DATA: Record<string, ModuleConfig> = {
  '/projects': {
    ...
    highlights: [
      ...
      'Physical vs financial expenditure variance mapping',
      'Implementing agency performance scoring and milestone adherence',
    ],
  },
  '/alerts': {
    title: 'Early-Warning Indicators & Risk Alerts',
    subtitle: 'Multi-criteria critical delay escalation engine with indicative lookahead.',
    category: 'Early-Warning Indicators',
    badge: '318 Active Flags',
    icon: AlertTriangle,
    highlights: [
      'Automated milestone slippage alerts based on leading indicators',
      'Right-of-Way (RoW) and environmental clearance blockage indicators',
      'Actionable ministerial escalation workflows with audit trails',
    ],
  },
  '/predictions': {
    title: 'Predictive Risk Assessment — Prototype',
    subtitle: 'Risk assessment based on available project cost, expenditure, physical progress and schedule indicators.',
    category: 'Risk Intelligence',
    badge: 'Prototype • Historical PAIMANA Data',
    icon: Sparkles,
    highlights: [
      'Derived risk indicators and completion trajectories from historical PAIMANA records',
      'Material cost escalation and capital deployment sensitivity simulations',
      'Agency delivery momentum and historical trend analysis',
    ],
  },
  '/explainability': {
    title: 'Explainable Risk Factors & Root Causes',
    subtitle: 'Transparent explainability identifying why each project is facing schedule slippage or cost pressure.',
    category: 'Explainability & Transparency',
    badge: 'Explainable Risk Factors',
    icon: SearchCode,
    highlights: [
      'Breakdown of top adverse and stabilizing risk contributors',
      'Land acquisition vs utility shifting vs contractor liquidity context',
      'Evidence-based risk summaries for decision-makers',
    ],
  },
  '/benchmarking': {
...
export const GenericModulePage: React.FC = () => {
  ...
  const moduleInfo = MODULE_DATA[location.pathname] || {
    ...
    icon: Layers,
    highlights: [
      'Interactive analytical views and verified dataset indicators',
