...
export const PAIMANA_PRIORITY_PROJECTS: PaimanaPriorityProject[] = [
  {
    ...
    costOverrunCr: 0.0,
    delayMonths: 7.0,
    currentProgress: 55.73,
    riskLevel: 'CRITICAL',
    keySignal: 'Charnockite hard-rock TBM drives & underwater Adyar River crossing delay',
    suggestedAction: 'Deploy high-pressure slurry TBMs and ensure round-the-clock traffic NOCs',
  },
  {
    id: '705728',
    ...
    costOverrunCr: 0.0,
    delayMonths: 28.0,
    currentProgress: 62.16,
    riskLevel: 'CRITICAL',
    keySignal: 'Undersea tunnel at Thane Creek & BKC underground terminus civil works',
    suggestedAction: 'Accelerate track slab manufacturing and maintain Gujarat viaduct momentum',
  },
  {
    id: '701263',
    ...
    costOverrunCr: 36330.0,
    delayMonths: 44.0,
    currentProgress: 92.1,
    riskLevel: 'CRITICAL',
    keySignal: 'Crude Distillation & Petrochemical Fluidized Catalytic Cracking unit integration',
    suggestedAction: 'Initiate steam blowing and hydro-testing of processing units for commercial COD',
  },
  {
    id: '701415',
    ...
    delayMonths: 47.0,
    currentProgress: 86.15,
    riskLevel: 'CRITICAL',
    keySignal: 'Earth-cum-Rockfill (ECRF) dam Gap-1 vibro-stone columns & diaphragm wall repair',
    suggestedAction: 'Complete diaphragm wall deep grouting inspection with Central Water Commission',
  },
  {
    id: '602182',
    ...
    costOverrunCr: 29793.39,
    delayMonths: 0.0,
    currentProgress: 17.93,
    riskLevel: 'HIGH',
    keySignal: 'Dam foundation curtain grouting & diversion tunnel invert concreting',
    suggestedAction: 'Accelerate river diversion works before peak monsoon river discharge',
  },
  {
    id: '705429',
    ...
    riskLevel: 'CRITICAL',
    keySignal: 'Tunnel boring machine mining through complex Himalayan geological fault shear zones',
    suggestedAction: 'Enforce pre-excavation drainage grouting to mitigate water ingress in Tunnel 8',
  },
  {
    id: '400424',
    ...
    costOverrunCr: 0.0,
    delayMonths: 48.0,
    currentProgress: 78.48,
    riskLevel: 'CRITICAL',
    keySignal: 'Forest Land Stage-II diversion & mega heavy earthmoving machinery deployment',
    suggestedAction: 'Expedite environmental clearance compliance for 70 MTPA peak dispatch',
  },
  {
    id: '706775',
    ...
    revisedCostCr: 188000.0,
    expenditureCr: 48809.69,
    costOverrunCr: 126891.0,
    delayMonths: 43.0,
    currentProgress: 99.98,
    riskLevel: 'HIGH',
    keySignal: 'Gram Panchayat optical fiber last-mile link validation & block network equipment',
    suggestedAction: 'Transition completed panchayats to state operational maintenance concessions',
  },
  {
    id: '702637',
    ...
    delayMonths: 29.0,
    currentProgress: 99.21,
    riskLevel: 'WATCH',
    keySignal: 'Phase-2 (BKC to Cuffe Parade) integrated signaling & station finishes',
    suggestedAction: 'Complete final trial runs and obtain CMRS statutory safety certificate',
  },
];
